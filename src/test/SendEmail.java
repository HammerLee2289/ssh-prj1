...
{  
    ...
    {      
         ...
         mail.setSender("827876930@qq.com");             //发送人  
         mail.setName("昵称");                    //发送人昵称  
         mail.setReceiver("swd466@sohu.com");           //接收人    
         mail.setUsername("827876930@qq.com");           //登录账号,一般都是和邮箱名一样  
         mail.setPassword("gkhpjyfffflabbhi");  //QQ邮箱登录第三方客户端时,密码框请输入“授权码”进行验证。其他的密码具体查看邮件服务器的说明  
         mail.setSubject("标题");    
