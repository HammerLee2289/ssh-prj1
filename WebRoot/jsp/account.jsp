					...
					<ul class="nav pull-right">
						...
						<li class="dropdown"><a data-toggle="dropdown"
							...
							<ul class="dropdown-menu">
								<li><a href="./account.jsp"><i class="icon-user"></i>
			...
			<div class="row">
				...
				<div class="span3">
					...
					<ul id="main-nav" class="nav nav-tabs nav-stacked">
						...
						<li><a href="./"> <i class="icon-home"></i> Dashboard
						</a></li>

						<li><a href="./faq.jsp"> <i class="icon-pushpin"></i>
								FAQ
						</a></li>

						<li><a href="./plans.jsp"> <i class="icon-th-list"></i>
								Pricing Plans
						</a></li>

						<li class=""><a href="./grid.jsp"> <i
								class="icon-th-large"></i> Grid Layout <span
								class="label label-warning pull-right">5</span>
						</a></li>

						<li><a href="./charts.jsp"> <i class="icon-signal"></i>
								Charts
						</a></li>

						<li class="active"><a href="./account.jsp"> <i
								class="icon-user"></i> User Account
						</a></li>

						<li><a href="./login.jsp"> <i class="icon-lock"></i>
								Login
						</a></li>
													...
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="input-medium disabled"
																id="username" value="goideate" disabled="" />
