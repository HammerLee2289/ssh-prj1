...
<body onload="changeActive('menu4')">
<h2 class="sub-header"><span class="glyphicon glyphicon-question-sign" aria-hidden="true" style = "font-size:20px;"></span>&nbsp;&nbsp;Frequently Asked Questions</h2>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu" 
						...
						<li class="divider"></li>
						<li><a href="#spring1" tabindex="-1">spring1</a></li>
					</ul>
				</li>
			</ul>
		</div>
